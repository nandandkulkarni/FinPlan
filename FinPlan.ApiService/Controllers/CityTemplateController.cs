...
public class CityTemplateController : ControllerBase
{
    ...
    // GET: api/citytemplate/{cityId}/profiles
    ...
    // DELETE: api/citytemplate/{cityId}
    [HttpDelete("{cityId}")]
    ...
    // POST: api/citytemplate/{cityId}/profiles
    ...
    // GET: api/citytemplate/profile/{profileId}
    ...
    // PUT: api/citytemplate/profile/{profileId}
    ...
    // DELETE: api/citytemplate/profile/{profileId}
        ...
        [FromQuery] int childrenCount)
    {
        try
        {
            ...
            // Simple matching algorithm: score each profile
    ...
    private int CalculateMatchScore(DemographicProfile profile, int age, MaritalStatus maritalStatus, int childrenCount)
    {
        ...
        // Marital status match (0-50 points)
        if (profile.MaritalStatus == maritalStatus)
        {
            score += 50;
        }

        // Children count match (0-50 points)
